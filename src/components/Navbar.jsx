    ...
    <>
      ...
      >
        ...
        <div className="lp-nav-actions">
          <a href="https://attendance.ryzeworks.tech/" className="btn-ghost" target="_blank" rel="noopener noreferrer">Sign in</a>
        ...
        <div className="fm-inner">
          ...
          <div className="fm-footer">
            <div className="fm-footer-btns">
              <a href="https://attendance.ryzeworks.tech/" className="fm-btn fm-btn-ghost" onClick={closeMenu} target="_blank" rel="noopener noreferrer">
                Sign in
              </a>
